...
OPS = {
  'avg_pool_3x3' : lambda C, C2, stride, affine: AvgPool2d(C, C2, 3, stride=stride, padding=1, count_include_pad=False),
  'max_pool_3x3' : lambda C, C2, stride, affine: MaxPool2d(C, C2, 3, stride=stride, padding=1, count_include_pad=False), #(3, stride=stride, padding=1), #add batch normalization here
  'sep_conv_3x3' : lambda C, C2, stride, affine: SepConv(C, C2, 3, stride, 1, affine=affine),
  #'2_stacked_sep_conv_3x3': lambda C, stride, affine: StackedSepConv(C, C, 3, stride, 1, 2),
  'sep_conv_5x5' : lambda C, C2, stride, affine: SepConv(C, C2, 5, stride, 2, affine=affine),
  #'3_stacked_sep_conv_3x3': lambda C, stride, affine: StackedSepConv(C, C, 3, stride, 1, 3),
  'sep_conv_7x7' : lambda C, C2, stride, affine: SepConv(C, C2, 7, stride, 3, affine=affine),
  'dil_conv_3x3' : lambda C, C2, stride, affine: DilConv(C, C2, 3, stride, 2, 2, affine=affine),
  #'2_stacked_dil_conv_3x3': lambda C, stride, affine: StackedDilConv(C, C, 3, stride, 2, 2, 2),
  'dil_conv_5x5' : lambda C, C2, stride, affine: DilConv(C, C2, 5, stride, 4, 2, affine=affine),
